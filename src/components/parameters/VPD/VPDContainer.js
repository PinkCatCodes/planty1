...
import LastFetchedInfo from "../../reUsables/LastfetchedInfo";
import SendDataForm from "../../reUsables/SendDataForm";
import ThresholdSettings from "../../reUsables/ThresholdSettings";
import Notification from "../../reUsables/Notification";
import Chart from "../../charts/Chart";

import "./VPDContainer.css";

function VPDContainer() {
    ...
    <div className="vpd-container">
      ...
      <div className="container3">
        ...
        <div className="graph3">
          <h3>Graph:</h3>
          <Chart dataKey="vaporPressureDeficit" yAxisLabel="VPD kPa" />
        </div>
      </div>
    </div>
  );
